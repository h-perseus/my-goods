...
const REQUEST_KEY = (
  id: string
): readonly [string, string] => ['requests', id];
...
const USER_KEY = (
  id: string
): readonly [string, string] => ['users', id];

const CONNECTION_LIST_KEY = (
  searchOptions?: any
): [string] | [string, any] => {
  if (searchOptions === undefined) {
    return ['connections'];
...
const CONNECTION_KEY = (
  id: string
): readonly [string, string] => ['connections', id];

const DOMAIN_LIST_KEY = (
  searchOptions?: any
): [string] | [string, any] => {
  if (searchOptions === undefined) {
    return ['domains'];
...
const DOMAIN_KEY = (
  id: string
): readonly [string, string] => ['domains', id];
