import {
  ...
  export const ConnectionList = ({connections, setSelectedConnections, handleDeleteItem}: { connections: any[], setSelectedConnections: (ids: string[]) => void, handleDeleteItem: (id: string) => void}): JSX.Element => {
