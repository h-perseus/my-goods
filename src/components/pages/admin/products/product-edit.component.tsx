...
import { useProductEdit } from "../../../../api/products/hooks/use-product-edit.hook";
...
export const ProductEditComponent = (): JSX.Element => {
  ...
  const { edit, isInProgress } = useProductEdit();
  ...
  return (
    <>
      <Form
        ...
        <NumberField label="판매가격" minValue={0} value={payload.price}  onChange={(value) => {
