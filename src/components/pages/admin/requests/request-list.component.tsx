...
import { PATHS, ROUTER_PATHS } from "../../../../routes";
  ...
  export const RequestList = ({requests, setSelectedRequests, handleDeleteItem}: { requests: any[], setSelectedRequests: (ids: string[]) => void, handleDeleteItem: (id: string) => void}): JSX.Element => {
                ...
                if (key === "product.image") {
                    ...
                    return (
                      ...
                      <ActionButton isQuiet onPress={() => {
                        navigate(ROUTER_PATHS.ADMIN + PATHS.getRequestUrl(item._id))
                      }}>
                          <ArrowRight />
                      </ActionButton>
                      <ActionButton isQuiet onPress={() => {
